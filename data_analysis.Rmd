...
###boxplots 
```{r}
ggplot(data =final_sample, aes(x= AGE, y = INCEARN, color= as.factor(SEX))) + 
         geom_boxplot()
ggplot(data =final_sample, aes(x= AGE, y = INCEARN, color= as.factor(MARST))) + 
         geom_boxplot()
ggplot(data =final_sample, aes(x= AGE, y = INCEARN, color= as.factor(RACE))) + 
         geom_boxplot()
ggplot(data =final_sample, aes(x= UHRSWORK, y = INCEARN, color= as.factor(SEX))) + 
         geom_boxplot()
ggplot(data =final_sample, aes(x= UHRSWORK, y = INCEARN, color= as.factor(RACE))) + 
         geom_boxplot()
ggplot(data =final_sample, aes(x= UHRSWORK, y = INCEARN, color= as.factor(MARST))) + 
         geom_boxplot()
```
